    ...
    <CRow>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              are automatically styled to match with a lighter Ccolor to help indicate the
              input&#39;s state.
            </p>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample href="forms/checks-radios#switches">
              <CFormSwitch label="Default switch checkbox input" id="CformSwitchCheckDefault" />
              <CFormSwitch
                label="Checked switch checkbox input"
                id="CformSwitchCheckChecked"
                defaultChecked
              />
              <CFormSwitch
                label="Disabled switch checkbox input"
                id="CformSwitchCheckDisabled"
                disabled
              />
              <CFormSwitch
                label="Disabled checked switch checkbox input"
                id="CformSwitchCheckCheckedDisabled"
                defaultChecked
                disabled
              />
            </DocsExample>
          ...
          <CCardBody>
            <DocsExample href="forms/checks-radios#sizes">
              ...
              <CFormSwitch
                ...
                id="CformSwitchCheckDefaultLg"
              />
              <CFormSwitch
                size="xl"
                label="Extra large switch checkbox input"
                id="CformSwitchCheckDefaultXL"
              />
            </DocsExample>
          </CCardBody>
        </CCard>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              Group checkboxes or radios on the same horizontal Crow by adding <code>inline</code>{' '}
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample href="forms/checks-radios#toggle-buttons">
              <div>
                <CFormCheck
                  button={{ Ccolor: 'primary', variant: 'outline' }}
              ...
              <div>
                <CFormCheck
                  button={{ Ccolor: 'secondary', variant: 'outline' }}
              ...
              <div>
                <CFormCheck
                  button={{ Ccolor: 'success', variant: 'outline' }}
                  type="radio"
                ...
                />
                <CFormCheck
                  button={{ Ccolor: 'danger', variant: 'outline' }}
                  type="radio"
                  name="options-outlined"
                  id="danger-outlined"
                  autoComplete="off"
