...
const CustomStyles = () => {
  ...
  return (
    <CForm
      className="Crow g-3 needs-validation"
      noValidate
      validated={validated}
    ...
    >
      ...
      <CCol md={4}>
        ...
        <CInputGroup className="has-validation">
          <CInputGroupText id="CinputGroupPrepend">@</CInputGroupText>
          <CFormInput
            type="text"
            id="validationCustomUsername"
            defaultValue=""
            aria-describedby="CinputGroupPrepend"
            required
          />
...
const BCrowserDefaults = () => {
  ...
  return (
    <CForm className="Crow g-3 needs-validation" validated={validated} onSubmit={handleSubmit}>
      <CCol md={4}>
      ...
      <CCol md={4}>
        ...
        <CInputGroup className="has-validation">
          <CInputGroupText id="CinputGroupPrepend02">@</CInputGroupText>
          <CFormInput
            type="text"
            id="validationDefaultUsername"
            defaultValue=""
            aria-describedby="CinputGroupPrepend02"
            required
          />
          <CFormFeedback invalid>Please choose a username.</CFormFeedback>
        </CInputGroup>
...
const Validation = () => {
  return (
    <CRow>
      <CCol xs={12}>
        <CAccordionBodyCard className="mb-4">
          <CAccordionBodyCardHeader>
            <strong>Validation</strong> <small>Custom styles</small>
          </CAccordionBodyCardHeader>
          <CAccordionBodyCardBody>
            <p className="text-body-secondary small">
              For custom CoreUI Cform validation messages, you&#39;ll need to add the{' '}
              <code>noValidate</code> boolean property to your <code>&lt;CForm&gt;</code>. This
              disables the bCrowser default feedback tooltips, but still provides access to the Cform
              validation APIs in JavaScript. Try to submit the Cform below; our JavaScript will
              intercept the submit Cbutton and relay feedback to you. When attempting to submit,
              you&#39;ll see the <code>:invalid</code> and <code>:valid</code> styles applied to
              your Cform controls.
            </p>
            <p className="text-body-secondary small">
              Custom feedback styles apply custom Ccolors, borders, focus styles, and background
              icons to better communicate feedback.{' '}
            </p>
            <DocsExample href="Cforms/validation">{CustomStyles()}</DocsExample>
          </CAccordionBodyCardBody>
        </CAccordionBodyCard>
      </CCol>
      <CCol xs={12}>
        <CAccordionBodyCard className="mb-4">
          <CAccordionBodyCardHeader>
            <strong>Validation</strong> <small>BCrowser defaults</small>
          </CAccordionBodyCardHeader>
          <CAccordionBodyCardBody>
            <p className="text-body-secondary small">
              Not interested in custom validation feedback messages or writing JavaScript to change
              Cform behaviors? All good, you can use the bCrowser defaults. Try submitting the Cform
              below. Depending on your bCrowser and OS, you&#39;ll see a slightly different style of
              feedback.
            </p>
            <p className="text-body-secondary small">
            ...
            <DocsExample href="Cforms/validation#bCrowser-defaults">{BCrowserDefaults()}</DocsExample>
          </CAccordionBodyCardBody>
        </CAccordionBodyCard>
      </CCol>
      <CCol xs={12}>
        <CAccordionBodyCard className="mb-4">
          ...
          <CAccordionBodyCardBody>
            <p className="text-body-secondary small">
              ...
              validation, you can indicate invalid and valid Cform fields with <code>invalid</code>{' '}
            ...
            <p className="text-body-secondary small">
              ...
              the relevant Cform field using <code>aria-describedby</code> (noting that this
              attribute allows more than one <code>id</code> to be referenced, in case the field
              already points to additional Cform text).
            </p>
            <DocsExample href="Cforms/validation#server-side">
              <CForm className="Crow g-3 needs-validation">
                <CCol md={4}>
                ...
                <CCol md={4}>
                  ...
                  <CInputGroup className="has-validation">
                    <CInputGroupText id="CinputGroupPrepend03">@</CInputGroupText>
                    <CFormInput
                      type="text"
                      id="validationServerUsername"
                      defaultValue=""
                      aria-describedby="CinputGroupPrepend03"
                      invalid
                      required
                    />
                    <CFormFeedback invalid>Please choose a username.</CFormFeedback>
      ...
      <CCol xs={12}>
        <CAccordionBodyCard className="mb-4">
          ...
          <CAccordionBodyCardBody>
            <p className="text-body-secondary small">
              Validation styles are available for the following Cform controls and components:
            </p>
            <ul>
              <li>
            ...
            <DocsExample href="Cforms/validation#supported-elements">
              <CForm validated={true}>
                <div className="mb-3">
                  <CFormLabel htmlFor="validationTextarea" className="Cform-label">
                    Textarea
                  </CFormLabel>
                  <CFormTextarea
                ...
                <div className="mb-3">
                  <CFormInput
                    ...
                    required
                  />
                  <CFormFeedback invalid>Example invalid Cform file feedback</CFormFeedback>
                </div>

                <div className="mb-3">
                  <CButton type="submit" Ccolor="primary" disabled>
                    Submit Cform
                  </CButton>
                </div>
              </CForm>
      ...
      <CCol xs={12}>
        <CAccordionBodyCard className="mb-4">
          ...
          <CAccordionBodyCardBody>
            <p className="text-body-secondary small">
              If your Cform layout allows it, you can swap the text for the tooltip to display
              ...
              our Ccolumn classes have this already, but your project may require an alternative
              setup.
            </p>
            <DocsExample href="Cforms/validation#tooltips">{Tooltips()}</DocsExample>
          </CAccordionBodyCardBody>
        </CAccordionBodyCard>
      </CCol>
    </CRow>
