    ...
    <CRow>
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            <strong>React CButton Group</strong> <span>Basic example</span>
          </CCardHeader>
          <CCardBody>
            <p>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            <strong>React CButton Group</strong> <span>Mixed styles</span>
          </CCardHeader>
          <CCardBody>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            <strong>React CButton Group</strong> <span>Outlined styles</span>
          </CCardHeader>
          <CCardBody>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            <strong>React CButton Group</strong> <span>Checkbox and radio button groups</span>
          </CCardHeader>
          <CCardBody>
            <p>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            <strong>React CButton Group</strong> <span>CButton toolbar</span>
          </CCardHeader>
          <CCardBody>
            <p>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            <strong>React CButton Group</strong> <span>Sizing</span>
          </CCardHeader>
          <CCardBody>
            <p>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            <strong>React CButton Group</strong> <span>Nesting</span>
          </CCardHeader>
          <CCardBody>
            ...
            <DocsExample href="components/button-group#nesting">
              <CButtonGroup role="group" aria-label="CButton group with nested dropdown">
                <CButton color="primary">1</CButton>
                <CButton color="primary">2</CButton>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            <strong>React CButton Group</strong> <span>Vertical variation</span>
          </CCardHeader>
          <CCardBody>
            <p className="text-body-secondary small">
            ...
            <DocsExample href="components/button-group/#vertical-variation">
              <CButtonGroup vertical role="group" aria-label="Vertical button group">
                <CButton color="dark">CButton</CButton>
                <CButton color="dark">CButton</CButton>
                <CButton color="dark">CButton</CButton>
                <CButton color="dark">CButton</CButton>
                <CButton color="dark">CButton</CButton>
